// @ts-nocheck
// game-board.tsx — 시안에서 옮겨온 게임 보드 화면(원형 보존 1차 마이그).
// 점진적 타입화·컴포넌트 분리·Zustand store 분리는 다음 PR에서.

import * as React from 'react';
import { CARD_BY_ID, CARD_CATALOG, CARD_CATEGORY, MONTH_LABELS } from './cards-data';
import { HwatuCard, HwatuCardBack } from './hwatu-card';

// @ts-nocheck
// hwatu-card.tsx — 시안에서 옮겨온 화투 카드 시각 컴포넌트(원형 보존 1차 마이그).
// 민화 평면 일러스트 시스템. 실제 화투 패 사진을 트레이스하지 않는다.
// 모든 실루엣은 SVG 프리미티브로 직접 그림.
// 점진적 타입화·정리는 다음 PR에서 진행.

import * as React from 'react';
import { CARD_CATEGORY, MONTH_LABELS, MONTH_PALETTE } from './cards-data';
...
export { HwatuCard, HwatuCardBack };

// settlement.jsx — round-end settlement with category breakdown,
// 단(短) bonus mini-event, animated counter-ups, winner reveal.

const { HwatuCard, MONTH_LABELS: ML, CARD_CATEGORY: CC, CARD_BY_ID: CBI } = window;
...
Object.assign(window, { Settlement, settlementScore, detectDan });
